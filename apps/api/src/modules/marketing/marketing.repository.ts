...
export interface MarketingRepository {
  ...
  replaceMappings(tenantId: string, rows: BusinessCustomerMappingInput[], fileName: string, fileHash: string, actor: MarketingActor): Promise<{ imported: number; repeated: boolean }>;
