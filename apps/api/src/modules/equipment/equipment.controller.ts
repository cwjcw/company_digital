...
export class EquipmentController {
  ...
  @Delete("assets/:id") disableAsset(@Param("id") id: string, @Body() body: { expectedVersion: number }, @Req() request: EquipmentRequest) { return this.application.disableAsset(id, body.expectedVersion, this.actor(request)); }
  ...
  @Delete("status-reports/:id") disableStatus(@Param("id") id: string, @Body() body: { expectedVersion: number }, @Req() request: EquipmentRequest) { return this.application.disableStatus(id, body.expectedVersion, this.actor(request)); }
  ...
  @Get("options") options(@Req() request: EquipmentRequest) { return this.queries.formOptions(this.actor(request)); }
