...
export class PlanningOperationsController {
  ...
  @Post("weekly-periods/current/sync-order-schedules") syncWeekly(@Req() req:OperationRequest,@Headers("x-tenant-code") tenant:string|undefined,@Ip() ip:string){return this.application.syncCurrentWeekly(this.actor(req,tenant,ip));}
