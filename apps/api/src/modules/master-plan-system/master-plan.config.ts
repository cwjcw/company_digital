...
export type MasterPlanResource = {
  ...
  divisionField?: string; requiredOnCreate?: string[]; extraColumns?: Record<string, string>;
};
...
export const MASTER_PLAN_RESOURCES: MasterPlanResource[] = [
  ...
  { code: "mps-customer-divisions", table: "mps_customer_division_mappings", create: true, remove: true, defaultOrder: "customer_code", divisionField: "primaryDivisionId", requiredOnCreate: ["customerCode", "primaryDivisionId"] },
  { code: "mps-order-allocations", table: "mps_order_allocations", create: false, remove: false, defaultOrder: "order_date DESC,order_number,item_code", divisionField: "divisionId" },
  { code: "mps-process-cycles", table: "mps_process_cycles", create: true, remove: true, defaultOrder: "item_code", requiredOnCreate: ["itemCode"] },
  ...
  { code: "mps-shipping-plans", table: "mps_shipping_plans", create: true, remove: true, defaultOrder: "latest_customer_due_date,order_number,item_code,delivery_number", divisionField: "divisionId", requiredOnCreate: ["customerCode", "orderNumber", "itemCode", "deliveryNumber", "latestCustomerDueDate", "plannedQuantity"] },
  { code: "mps-base-plans", table: "mps_base_plans", create: false, remove: false, defaultOrder: "latest_customer_due_date,order_number,item_code,delivery_number", divisionField: "divisionId" },
  { code: "mps-weekly-plans", table: "mps_weekly_plans", create: false, remove: false, defaultOrder: "latest_review_due_date,order_number,item_code,delivery_number", divisionField: "divisionId" },
  { code: "mps-weekly-process-plans", table: "mps_weekly_process_plans", create: false, remove: false, defaultOrder: "due_date,sequence,weekly_plan_id" },
  { code: "mps-technical-reports", table: "mps_technical_reports", create: false, remove: false, defaultOrder: "drawing_due_date,order_number,item_code,delivery_number" },
  { code: "mps-material-reports", table: "mps_material_reports", create: true, remove: true, defaultOrder: "order_number,item_code,delivery_number,material_name", requiredOnCreate: ["weeklyPlanId", "materialName"] },
  { code: "mps-outsourcing-reports", table: "mps_outsourcing_reports", create: false, remove: false, defaultOrder: "outsourcing_due_date,order_number,item_code,delivery_number" },
  { code: "mps-process-reports", table: "mps_process_reports", create: true, remove: true, defaultOrder: "production_date DESC,order_number,item_code,delivery_number", requiredOnCreate: ["weeklyPlanId", "processCode", "productionDate", "productionQuantity"], extraColumns: { processName: "process_name" } },
