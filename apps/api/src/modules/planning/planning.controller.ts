...
export class PlanningController {
  ...
  @Get("versions/:versionId/items") items(@Param("versionId") versionId: string, @Query("orderNumber") orderNumber: string | undefined, @Query("itemNumber") itemNumber: string | undefined, @Req() req: PlanningRequest, @Headers("x-tenant-code") tenant: string | undefined, @Ip() ip: string) { return this.queries.searchPlanItems({ versionId, orderNumber, itemNumber }, this.actor(req, tenant, ip)); }
