...
@Module({
  ...
  providers: [
    AuthGuard, PlanningDomainEventBus, PlanningDomainService, PlanningApplicationService, PlanQueryService, PlanningImportService, PlanningExportService, PlanningImageService, PlanGateway,
