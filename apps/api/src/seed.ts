...
async function seed() {
  ...
  const resources = ["sales-summary-dashboard", "on-hand-summary-dashboard", "rolling-plan", "monthly-plan", "weekly-plan", "work-report", "sales-orders", "finished-goods-inbound", "finished-goods-outbound", "business-customer-mapping", "order-schedule", "suppliers", "dictionaries", "processes", "users", "roles", "organization", "audit-logs", "imports"];
