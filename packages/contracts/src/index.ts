...
export const tablePermissionFieldRegistry: Partial<Record<TableResourceCode, TablePermissionFieldDefinition[]>> = {
  ...
  "mps-erp-orders": fields([["sourceAccountName", "来源账套", "text", false], ["salespersonName", "业务员", "text", false], ["customerCode", "客户编码", "text", false], ["customerName", "客户名称", "text", false], ["orderNumber", "订单编号", "text", false], ["orderType", "订单类型", "text", false], ["orderDate", "订单日期", "date", false], ["customerDueDate", "客户交期", "date", false], ["preproductionReviewDate", "产前评审日期", "date", false], ["expectedShippingDate", "预计出货日期", "date", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["unit", "单位", "text", false], ["orderQuantity", "订单数量", "number", false], ["taxIncludedUnitPrice", "含税单价", "number", false], ["taxIncludedAmount", "含税金额", "number", false], ["orderStatus", "订单状态", "text", false]]),
  "mps-customer-divisions": fields([["customerCode", "客户编码", "text", true, true], ["customerName", "客户名称"], ["primaryDivisionId", "主责事业部", "department", true, true], ["enabled", "启用", "boolean"], ["remark", "备注"]]),
  "mps-order-allocations": fields([["salespersonName", "业务员", "text", false], ["customerCode", "客户编码", "text", false], ["orderNumber", "订单编号", "text", false], ["orderDate", "订单日期", "date", false], ["expectedShippingDate", "预计出货日期", "date", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["unit", "单位", "text", false], ["orderQuantity", "订单数量", "number", false], ["allocatedQuantity", "分配数量", "number", false], ["divisionId", "承接事业部", "department"], ["remark", "备注"]]),
  "mps-process-cycles": fields([["itemCode", "品号", "text", true, true], ["itemName", "品名"], ["technicalDays", "技术周期", "number"], ["cuttingDays", "下料周期", "number"], ["machiningDays", "机加周期", "number"], ["bendingDays", "折弯周期", "number"], ["spotWeldingDays", "点焊周期", "number"], ["weldingDays", "焊接周期", "number"], ["woodworkingDays", "木作周期", "number"], ["grindingDays", "研磨周期", "number"], ["surfaceTreatmentDays", "表面处理周期", "number"], ["packagingDays", "包装周期", "number"]]),
  "mps-group-plans": fields([["sourceAccounts", "来源账套", "text", false], ["orderNumber", "订单编号", "text", false], ["orderType", "订单类型", "text", false], ["customerCode", "客户编码", "text", false], ["customerName", "客户名称", "text", false], ["orderDate", "订单日期", "date", false], ["customerDueDate", "客户交期", "date", false], ["preproductionReviewDate", "产前评审日期", "date", false], ["orderAmount", "订单金额", "number", false], ["requiredQuantity", "需求数量", "number", false], ["primaryDivisionId", "主责事业部", "department", false], ["completedQuantity", "完成数量", "number", false], ["pendingQuantity", "待完成数量", "number", false], ["completionRate", "完成比例", "number", false]]),
  "mps-monthly-plans": fields([["divisionId", "承接事业部", "department", false], ["customerCode", "客户编码", "text", false], ["customerName", "客户名称", "text", false], ["orderNumber", "订单编号", "text", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["orderDate", "订单日期", "date", false], ["customerDueDate", "客户交期", "date", false], ["preproductionReviewDate", "产前评审日期", "date", false], ["latestCustomerDueDate", "最迟客户交期", "date"], ["modelAge", "模龄"], ["productAttribute", "产品属性"], ["surfaceNature", "表面性质"], ["specialItem", "特殊事项"], ["requiredQuantity", "需求数量", "number", false], ["cumulativeInboundQuantity", "累计入库数量", "number", false], ["pendingQuantity", "欠数", "number", false], ["completionRate", "完成比例", "number", false], ["manufacturingMethod", "生产方式", "dictionary"], ["plannedPageCount", "计划页数", "number"], ["orderExceptionInfo", "订单异常信息"], ["inspectionRequired", "是否验货", "boolean"], ["inspectionQuantity", "验货数量", "number"], ["remark", "备注"], ["orderWeekCount", "下单周数", "number", false]]),
  "mps-shipping-plans": fields([["customerCode", "客户编码", "text", true, true], ["orderNumber", "订单编号", "text", true, true], ["itemCode", "品号", "text", true, true], ["itemName", "品名"], ["deliveryNumber", "交次", "number", true, true], ["orderDate", "订单日期", "date"], ["latestCustomerDueDate", "最迟客户交期", "date", true, true], ["plannedQuantity", "计划数量", "number", true, true], ["divisionId", "承接事业部", "department"], ["modelAge", "模龄"], ["enteredWeeklyPlan", "已进入周计划", "boolean", false]]),
  "mps-base-plans": fields([["divisionId", "承接事业部", "department", false], ["customerCode", "客户编码", "text", false], ["orderNumber", "订单编号", "text", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["deliveryNumber", "交次", "number", false], ["orderDate", "订单日期", "date", false], ["latestCustomerDueDate", "最迟客户交期", "date", false], ["plannedQuantity", "计划数量", "number", false], ["latestReviewDueDate", "最迟评审交期", "date"], ["modelAge", "模龄"], ["productAttribute", "产品属性"], ["surfaceNature", "表面性质"], ["manufacturingMethod", "生产方式", "dictionary"], ["admissionStatus", "准入状态", "dictionary", false], ["admissionMessage", "准入说明", "text", false]]),
  "mps-weekly-plans": fields([["divisionId", "承接事业部", "department", false], ["customerCode", "客户编码", "text", false], ["orderNumber", "订单编号", "text", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["deliveryNumber", "交次", "number", false], ["orderDate", "订单日期", "date", false], ["latestCustomerDueDate", "最迟客户交期", "date", false], ["latestReviewDueDate", "最迟评审交期", "date", false], ["plannedQuantity", "计划数量", "number", false], ["allocatedInboundQuantity", "分摊入库数量", "number", false], ["pendingQuantity", "欠数", "number", false], ["manufacturingMethod", "生产方式", "dictionary", false], ["drawingDueDate", "图纸交期", "date", false], ["hardwareDueDate", "五金交期", "date", false], ["woodDueDate", "木作交期", "date", false], ["plannedPageCount", "计划页数", "number"], ["orderExceptionInfo", "订单异常信息"], ["inspectionRequired", "是否验货", "boolean"], ["inspectionQuantity", "验货数量", "number"], ["remark", "备注"]]),
  "mps-weekly-process-plans": fields([["weeklyPlanId", "周计划", "text", false], ["processCode", "工序编码", "text", false], ["processName", "工序", "text", false], ["sequence", "工序顺序", "number", false], ["cycleDays", "周期天数", "number", false], ["dueDate", "工序交期", "date", false], ["reportedQuantity", "累计报工", "number", false], ["status", "状态", "dictionary", false], ["exceptionText", "异常说明", "text", false]]),
  "mps-technical-reports": fields([["orderNumber", "订单编号", "text", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["deliveryNumber", "交次", "number", false], ["responsibleUserId", "责任人", "member"], ["drawingDueDate", "图纸交期", "date", false], ["status", "状态", "dictionary"], ["exceptionText", "异常说明"]]),
  "mps-material-reports": fields([["weeklyPlanId", "周计划", "text", true, true], ["orderNumber", "订单编号", "text", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["deliveryNumber", "交次", "number", false], ["materialName", "主材", "dictionary", true, true], ["received", "已入库", "boolean"], ["actualInboundDate", "实际入库日期", "date"], ["exceptionText", "异常说明"]]),
  "mps-outsourcing-reports": fields([["orderNumber", "订单编号", "text", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["deliveryNumber", "交次", "number", false], ["purchaseOrderNumber", "采购单号"], ["supplierId", "供应商", "text"], ["outsourcingMethod", "外协方式", "dictionary"], ["outsourcingDueDate", "外协交期", "date"], ["cycleDays", "周期天数", "number"], ["received", "已入库", "boolean"], ["actualInboundDate", "实际入库日期", "date"], ["status", "状态", "dictionary", false], ["exceptionText", "异常说明"]]),
  "mps-process-reports": fields([["weeklyPlanId", "周计划", "text", true, true], ["orderNumber", "订单编号", "text", false], ["itemCode", "品号", "text", false], ["itemName", "品名", "text", false], ["deliveryNumber", "交次", "number", false], ["processCode", "工序", "dictionary", true, true], ["productionDate", "生产日期", "date", true, true], ["plannedQuantity", "计划数量", "number", false], ["productionQuantity", "报工数量", "number", true, true]]),
