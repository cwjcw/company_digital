...
export const tablePermissionFieldRegistry: Partial<Record<TableResourceCode, TablePermissionFieldDefinition[]>> = {
  ...
  "equipment-status-report": fields([["equipmentId", "设备（关联台账）", "reference", true, false, { filterBinding: { kind: "column", referenceResource: "equipment-register", valueField: "id", labelField: "equipmentCode" } }], ["equipmentCode", "设备编号", "text", false], ["equipmentName", "设备名称", "text", false], ["divisionId", "事业部", "department", false], ["usageDepartmentId", "使用部门", "department", false], ["responsibleUserIds", "责任人", "member", false, false, { multiple: true }], ["reportDate", "填报日期", "date"], ["plannedRuntimeMinutes", "计划运行时间", "number", true, true, { format: "durationMinutes" }], ["runtimeMinutes", "实际运行时长", "number", true, false, { format: "durationMinutes" }], ["utilizationRate", "稼动率", "number", false, false, { format: "percentage", percentageScale: "percent", filterable: false }], ["faultMinutes", "故障时长", "number", true, false, { format: "durationMinutes" }], ["faultReason", "故障原因", "dictionary"]]),
  "equipment-dashboard": fields([["divisionId", "事业部", "department", false], ["departmentId", "使用部门", "department", false], ["equipmentId", "设备", "reference", false, false, { filterable: false, filterBinding: { kind: "column", referenceResource: "equipment-register", valueField: "id", labelField: "equipmentCode" } }], ["equipmentCode", "设备编号", "text", false], ["equipmentName", "设备名称", "text", false], ["totalEquipment", "设备总数", "number", false], ["reportedEquipment", "已填报设备", "number", false], ["missingEquipment", "未填报设备", "number", false], ["expectedEquipmentCount", "应填设备", "number", false], ["filledEquipmentCount", "已填设备", "number", false], ["unfilledEquipmentCount", "未填设备", "number", false], ["reportingRate", "填报率", "number", false, false, { format: "percentage", percentageScale: "percent" }], ["plannedRuntimeMinutes", "计划运行时间", "number", false, false, { format: "durationMinutes" }], ["runtimeMinutes", "实际运行时长", "number", false, false, { format: "durationMinutes" }], ["utilizationRate", "稼动率", "number", false, false, { format: "percentage", percentageScale: "percent" }], ["faultMinutes", "故障时长", "number", false, false, { format: "durationMinutes" }]]),
